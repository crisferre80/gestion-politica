        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/asura.santiagodelestero?locale=es_LA" className="text-white hover:text-green-200">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <span className="text-green-200">Av. Antenor Alvarez, Ciudad de Santiago del Estero</span>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 mr-2 text-green-300" />
                <span className="text-green-200">+54 385 5042155</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 mr-2 text-green-300" />
                <span className="text-green-200">asurasantiago@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
