        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/asura.santiagodelestero?locale=es_LA" className="text-white hover:text-blue-200">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/quienes-somos" className="text-blue-200 hover:text-white">¿Quiénes Somos?</a></li>
              <li><a href="/terminos-condiciones" className="text-blue-200 hover:text-white">Términos y Condiciones</a></li>
              <li><a href="/feedback" className="text-blue-200 hover:text-white">Reclamos y Sugerencias</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <span className="text-blue-200">Av. Antenor Alvarez, Ciudad de Santiago del Estero</span>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 mr-2 text-blue-300" />
                <span className="text-blue-200">+54 385 5042155</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 mr-2 text-blue-300" />
                <span className="text-blue-200">asurasantiago@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
