            ...
            {collectivePoint ? (
              <div>
                ...
                <div className="mt-4 pt-4 border-t border-gray-200">
                  {/* Contenedor responsivo para los botones */}
                  <div className="flex flex-col sm:flex-row justify-end gap-2 sm:gap-2">
                    {collectivePointClaim && (
                      <div className="relative order-1 sm:order-1" data-contact-menu style={{ zIndex: 9999 }}>
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                          ...
                          className="w-full sm:w-auto px-3 py-2 bg-green-600 text-white rounded-md flex items-center justify-center gap-2 hover:bg-green-700 transition-colors text-sm font-semibold shadow-sm"
                          data-contact-menu
                        >
                          <Phone className="w-4 h-4 flex-shrink-0" />
                          <span className="whitespace-nowrap">Contactar Reciclador</span>
                          <svg className={`w-4 h-4 flex-shrink-0 transition-transform ${showContactMenu ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        {showContactMenu && (
                          <div 
                            className="absolute left-0 sm:right-0 sm:left-auto top-full mt-2 w-full sm:w-48 bg-white rounded-lg shadow-xl border border-gray-200 overflow-hidden"
                            style={{ 
                              zIndex: 99999, 
                              position: 'absolute',
                              display: 'block',
                    ...
                    <button
                      ...
                      className="w-full sm:w-auto order-2 sm:order-2 px-3 py-2 bg-blue-600 text-white rounded-md flex items-center justify-center gap-2 hover:bg-blue-700 transition-colors text-sm font-semibold shadow-sm disabled:bg-gray-400 disabled:cursor-not-allowed"
                    ...
                    >
                      ...
                      <span className="whitespace-nowrap">Invitar con QR</span>
                    </button>
                    
                    <button
                      onClick={handleDeletePoint}
                      className="w-full sm:w-auto order-3 sm:order-3 px-3 py-2 bg-red-600 text-white rounded-md flex items-center justify-center gap-2 hover:bg-red-700 transition-colors text-sm font-semibold shadow-sm disabled:bg-gray-400 disabled:cursor-not-allowed"
                      disabled={!!collectivePointClaim}
