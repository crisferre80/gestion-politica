  ...
  return (
    <div className="max-w-3xl mx-auto py-10 px-4">
      <div className="bg-white rounded-xl shadow-lg p-8 border border-green-200">
        <h1 className="text-4xl font-extrabold text-green-800 mb-6 text-center tracking-tight">Dossier Institucional</h1>
        <h2 className="text-2xl font-bold text-green-700 mb-4 mt-2">¿Qué es Asura EcoNecta2?</h2>
        <p className="text-gray-700 mb-4">
          Es una app móvil que conecta a ciudadanos, recicladores y empresas para gestionar residuos reciclables de forma eficiente, segura y trazable. Permite solicitar recolección, visualizar rutas, enviar feedback y obtener eco-créditos.
        </p>
        <h2 className="text-2xl font-bold text-green-700 mb-4 mt-8">¿Quiénes somos?</h2>
        <p className="text-gray-700 mb-4">
        ...
        <h2 className="text-2xl font-bold text-green-700 mb-4 mt-8">¿Por qué ser Sponsor?</h2>
        ...
        <h2 className="text-2xl font-bold text-green-700 mb-4 mt-8">Formatos de Sponsoreo Disponibles</h2>
        <ul className="list-disc pl-6 text-gray-700 mb-6 space-y-1">
        ...
        <h2 className="text-2xl font-bold text-green-700 mb-4 mt-8">Contacto</h2>
